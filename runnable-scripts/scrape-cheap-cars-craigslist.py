...
scrape("2001-2006 Lexus LS430", base_query+parameters(min_price, 7000, 200000, 2004, 2020, "Lexus", "LS 430"))
scrape("2001-2006 Lexus LS430", "https://houston.craigslist.org/search/sss?query=lexus+ls430&srchType=T&hasPic=1&bundleDuplicates=1&search_distance=150&postal=77081&min_price=3100&max_price=6500&min_auto_year=2004")
scrape("2001-2006 Lexus LS430", "https://houston.craigslist.org/search/sss?query=lexus+ls+430&srchType=T&hasPic=1&bundleDuplicates=1&search_distance=150&postal=77081&min_price=3100&max_price=6500&min_auto_year=2004")
